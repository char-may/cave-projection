...
func fade() -> void:
	...
	Global.game_controller.change_gui_scene("res://screens/drawing_screen/2_creature_select_screen/creature_select_screen.tscn", true, false)
	
func _unhandled_input(event: InputEvent) -> void:
	if event.is_pressed():
		Global.game_controller.change_gui_scene("res://screens/drawing_screen/2_creature_select_screen/creature_select_screen.tscn")
